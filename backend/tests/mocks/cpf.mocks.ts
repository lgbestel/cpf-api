...
export const invalidExceptionOutput = { type: 'InvalidException', message: 'CPF is not valid.'};

export const existsExceptionOutput = { type: 'ExistsCpfException', message: 'CPF alerady exists'};

export const notFoundExceptionOutput = { type: 'NotFoundCpfException', message: 'CPF not found' };